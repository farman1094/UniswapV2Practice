...
import { WETH, DAI,  UNISWAP_V2_ROUTER_02 , UNISWAP_V2_PAIR_DAI_WETH} from "src/constants.sol";
...
contract UniswapV2TwapTest is Test {
    ...
    function getSpot2() internal view returns (uint256) {
        (uint112 reserve1, uint112 reserve0,) = pair.getReserves();
        // DAI / WETH
    ...
    function test_twap_close_to_last_spot() public {
        ...
        console2.log("twap0 dai", twap0);
        console2.log("twap1 weth", twap1);
    ...
    function testSpot() public view {
        uint256 spot = getSpot();
        uint256 spot2 = getSpot2();
        console2.log("DAI spot price", spot2);
        console2.log("ETH spot price", spot);
    }
}